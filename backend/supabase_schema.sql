...
(2,
 ...
 '<p>Esta oracion contiene las <strong>mismas palabras</strong> que la primera pero en un <strong>orden diferente</strong>. El cambio de orden sintactico altera las probabilidades de transicion del modelo HMM y puede revelar las <strong>limitaciones del contexto bigrama</strong>:</p><ul class="list-disc pl-5 space-y-2"><li><strong>«El»</strong> (DA0MS0): Articulo determinado masculino singular. <strong>Correcto.</strong></li><li><strong>«enfermo»</strong> (NCMS000): Sustantivo comun masculino singular. <strong>Correcto.</strong></li><li><strong>«grave»</strong> (AQ0CS0): Adjetivo calificativo, comun, singular. <strong>Correcto.</strong></li><li><strong>«habla»</strong>: Palabra <strong>clave de ambiguedad</strong>. Puede ser VMIP3S0 (verbo) o NCFS000 (sustantivo femenino). Linguisticamente es el verbo principal. El resultado depende de la implementacion: <em>HMM basico (sin suavizado)</em> etiqueta como <strong>NCFS000</strong> (incorrecto) porque el bigrama AQ0CS0→NCFS000 es mas frecuente; <em>HMM con suavizado de Laplace</em> etiqueta como <strong>VMIP3S0</strong> (correcto) porque el suavizado redistribuye la masa de probabilidad.</li><li><strong>«de»</strong> (SPS00): Preposicion. <strong>Correcto.</strong></li><li><strong>«trasplantes»</strong> (NCMP000): Sustantivo comun masculino plural. <strong>Correcto.</strong></li><li><strong>«.»</strong> (Fp): Signo de puntuacion. <strong>Correcto.</strong></li></ul><p><strong>Comparacion:</strong> En la primera oracion «Habla» en posicion inicial tiene q0→VMIP3S0 con alta probabilidad (ambas implementaciones aciertan). En la segunda, «habla» tras el adjetivo «grave» depende del suavizado utilizado. Este caso demuestra la limitacion del contexto bigrama y la importancia del smoothing.</p>'),
(3,
